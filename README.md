...
## Tool Structure
1.  `lib_SMML.py`: Core library containing the `SMMLEstimator` class and logic.

2.  `trainer.py`: Script to train the model and calculate thresholds.

3.  `meter.py`: Script to evaluate password strength.
